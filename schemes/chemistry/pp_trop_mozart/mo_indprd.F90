! Adapted from CAM/src/chemistry/pp_trop_mozart/mo_indprd.F90
! MOD for CAM-SIMA: use ccpp_kinds instead of shr_kind_mod
! MOD for CAM-SIMA: removed ppgrid; pver passed as subroutine argument
      module mo_indprd
      use ccpp_kinds, only : r8 => kind_phys  ! MOD for CAM-SIMA
      private
      public :: indprd
      contains
      subroutine indprd( class, prod, nprod, y, extfrc, rxt, ncol, pver )  ! MOD for CAM-SIMA: added pver arg
