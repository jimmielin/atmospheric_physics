! Adapted from CAM/src/chemistry/pp_trop_mozart/mo_prod_loss.F90
! MOD for CAM-SIMA: use ccpp_kinds instead of shr_kind_mod
! MOD for CAM-SIMA: removed ppgrid (pver not used in assumed-shape arrays)
      module mo_prod_loss
      ...
      ! MOD for CAM-SIMA: removed use ppgrid (pver not needed, assumed-shape arrays)
      implicit none
!--------------------------------------------------------------------
! ... dummy args
!--------------------------------------------------------------------
