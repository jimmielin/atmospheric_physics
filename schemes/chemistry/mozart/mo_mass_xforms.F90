! Source: CAM/src/chemistry/mozart/mo_mass_xforms.F90
! Adapted for atmospheric_physics: removed ppgrid dependency.
! pver is passed as explicit argument. Uses ccpp_kinds.
...
contains
  ...
  subroutine mmr2vmr( mmr, vmr, mbar, ncol, pver )
    !-----------------------------------------------------------------
  ...
  subroutine mmr2vmri( mmr, vmr, mbar, mi, ncol, pver )
    !-----------------------------------------------------------------
    !	... Xfrom from mass to volume mixing ratio
    !-----------------------------------------------------------------
  ...
  subroutine vmr2mmr( vmr, mmr, mbar, ncol, pver )
    !-----------------------------------------------------------------
  ...
  subroutine vmr2mmri( vmr, mmr, mbar, mi, ncol, pver )
    !-----------------------------------------------------------------
    !	... Xfrom from volume to mass mixing ratio
    !-----------------------------------------------------------------
  ...
  subroutine h2o_to_vmr( h2o_mmr, h2o_vmr, mbar, ncol, pver )
    !-----------------------------------------------------------------------
  ...
  subroutine h2o_to_mmr( h2o_vmr, h2o_mmr, mbar, ncol, pver )
    !-----------------------------------------------------------------------
